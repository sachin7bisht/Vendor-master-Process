...
from backend.utils.file_io import save_uploaded_files
from backend.utils.document_ops import load_documents
import hashlib
import sys
...
class ChatIngestor:
    def __init__( self,
        ...
        try:
            ...
            print("ChatIngestor initialized. log info")
        ...
        *,
        ...
        try:
            ...
            if search_type == "mmr":
                ...
                log.info("Using MMR search 11", k=k, fetch_k=fetch_k, lambda_mult=lambda_mult)
...
class FaissManager:
    def __init__(self, index_dir: Path, model_loader: Optional[ModelLoader] = None):
        ...
        print("index_dir for faiss", index_dir)
